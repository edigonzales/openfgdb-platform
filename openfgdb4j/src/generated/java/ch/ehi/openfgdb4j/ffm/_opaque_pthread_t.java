...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        OpenFgdbNative.C_LONG.withName("__sig"),
        OpenFgdbNative.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, OpenFgdbNative.C_CHAR).withName("__opaque")
