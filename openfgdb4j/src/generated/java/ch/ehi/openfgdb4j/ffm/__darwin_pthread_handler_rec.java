...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        OpenFgdbNative.C_POINTER.withName("__routine"),
        OpenFgdbNative.C_POINTER.withName("__arg"),
        OpenFgdbNative.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = OpenFgdbNative.upcallHandle(__routine.Function.class, "apply", $DESC);
